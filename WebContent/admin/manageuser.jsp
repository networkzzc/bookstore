		  ...
		  <table width="100%" border="1" cellspacing="0" cellpadding="5" class="booklist_table">
		    <tbody>
		      <tr>
		        ...
		        <td width="17%"><strong>用户名</strong></td>
		        <td width="11%"><strong>手机号</strong></td>
		        <td width="21%"><strong>Email</strong></td>
		        <td width="6%"><strong>性别</strong></td>
		        <td width="10%"><strong>出生日期</strong></td>
		        <td width="16%"><strong>积分</strong></td>
		      ...
		      <tr>
		        ...
		        <td height="30">${user.email}</td>
		        <td height="30">${user.sex}</td>
		        <td height="30">${user.birth}</td>
		        <td height="30">${user.integral}</td>
		        <td height="30"><a href="${pageContext.request.contextPath}/admin/adminupdateuserservlet?id=${user.userId}">修改</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/admindeleteuserservlet?id=${user.userId}" onclick="return isdel();">删除</a></td>
	          </tr>
	          </c:forEach>
	        </tbody>
	      </table>
		...
		<div class="booklist_bottom_left">
		  ...
		  <div class="booklist_bottom_right">
			<ul class="booklist_bottom_ul">
				...
				<c:otherwise>
					<li><a href="${pageContext.request.contextPath}/admin/adminuserlistservlet?pageIndex=1">首页</a></li>
					<li><a href="${pageContext.request.contextPath}/admin/adminuserlistservlet?pageIndex=${pageIndex-1}">上页</a></li>
				</c:otherwise>
				</c:choose>
				<c:choose>
				...
				<c:otherwise>
			    	<li><a href="${pageContext.request.contextPath}/admin/adminuserlistservlet?pageIndex=${pageIndex+1}">下页</a></li>
					<li><a href="${pageContext.request.contextPath}/admin/adminuserlistservlet?pageIndex=${pageCount}">末页</a></li>
				</c:otherwise>
				</c:choose>
		    </ul>
