...
<body>
	...
	<div class="admin_center_div">
		<div class="admin_center_left">
			<div class="admin_left_div">
				<ul id="test">
					...
					<li><a
						href="${pageContext.request.contextPath}/admin/adminlistservlet">后台用户</a></li>
		...
		<form action="${pageContext.request.contextPath}/admin/adminupdateadminservlet" method="post">
		<table width="528" border="0" cellspacing="10" cellpadding="0">
        <tbody>
          <tr><input name="adminid" value="<%=admin.getAdminId() %>" style="display:none">
            <td width="143" height="30" align="right">旧密码</td>
            <td width="331" height="30">
            <input type="password" name="oldpassword" class="addbook_text" required="required"></td>
          </tr>
          <tr>
            <td height="30" align="right">新密码</td>
            <td height="30"><input type="password" name="password" id="pw1" class="addbook_text" onkeyup="valiphone()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td valign="top"><input type="submit" class="addbook_submit" id="submit" value="修改" disabled="disabled" ></td>
          </tr>
        </tbody>
      </table>
      </form>
